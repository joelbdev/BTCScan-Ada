...
package body BIP32_Private is
   ...
   function Validate (S : String) return Boolean is
      package BTC_Base58 is new Base58(Stream_Length => 82);
   ...
   begin
      ...
      return Base58_Stream (1) = 4 
        and Base58_Stream (2) = 136
        and Base58_Stream (3) = 173
        and Base58_Stream (4) = 228
        and Base58_Stream(79..82) = Double_Sha256(Base58_Stream(1..78));
   exception
