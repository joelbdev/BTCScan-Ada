...
package body WIFCPK is
   ...
   function Validate (S : String) return Boolean is
      package BTC_Base58 is new Base58(Stream_Length => 38);
   ...
   begin
      ...
      return Base58_Stream (1) = 128
        and Base58_Stream (35..38) = Double_Sha256(Base58_Stream(1..34));
   exception
