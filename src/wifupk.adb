...
package body WIFUPK is
   ...
   function Validate (S : String) return Boolean is
      package BTC_Base58 is new Base58(Stream_Length => 37);
   ...
   begin
      ...
      return Base58_Stream(1) = 128 and Base58_Stream(34..37) = Double_Sha256(Base58_Stream(1..33));
   exception
