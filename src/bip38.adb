...
package body BIP38 is
   ...
   function Validate (S : String) return Boolean is
      package BTC_Base58 is new Base58(Stream_Length => 43);
   ...
   begin
      ...
      return Base58_Stream (1) = 1
        and Base58_Stream(40..43) = Double_Sha256(Base58_Stream(2..39));
   exception
